...
class _VideoPlayerScreen5State extends State<VideoPlayerScreen5> {
  late VideoPlayerController _controller;
  late Future<void> _initializeVideoPlayerFuture;
  @override
  void initState() {
